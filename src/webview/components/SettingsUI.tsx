...
import type {
  WebViewSettings,
  WebViewSettingsService,
} from "../services/WebViewSettingsService";
      ...
      <div className="space-y-3">
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              updateSetting("theme", e.target.value as WebViewSettings["theme"])
            }
      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              updateSetting("fontSize", Number.parseInt(e.target.value, 10))
            }
            className="w-full p-2 border border-vscode-input-border bg-vscode-input-background text-vscode-input-foreground rounded"
          />
        </div>
      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              updateSetting("enableVirtualScrolling", e.target.checked)
            }
            className="mr-2"
          />
          <span className="text-sm text-vscode-editor-foreground">

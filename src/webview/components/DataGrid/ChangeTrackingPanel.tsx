...
export const ChangeTrackingPanel: React.FC<ChangeTrackingPanelProps> = ({
  ...
  const [changeRecord, setChangeRecord] = useState<ChangeRecord>(() => changeTracker.getChangeRecord())
  const [statistics, setStatistics] = useState<ChangeStatistics>(() => changeTracker.getStatistics())
              ...
              <div className="sql-statements">
                ...
                <div className="sql-footer">
                  <div className="sql-note">
                    💡 These statements represent all pending changes and can be executed 

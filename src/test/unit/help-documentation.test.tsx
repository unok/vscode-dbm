...
describe("HelpDocumentationService", () => {
  ...
  describe("Service Initialization", () => {
    ...
    it("should provide search functionality", () => {
      ...
      expect(
        results.every((r) => r.content.toLowerCase().includes("database")),
      ).toBe(true);
    });
...
describe("HelpUI Component", () => {
  ...
  describe("Rendering", () => {
    it("should render help dialog with navigation", () => {
      ...
      expect(
        within(navElement).getByText("Getting Started"),
      ).toBeInTheDocument();
      expect(
        within(navElement).getByText("Database Connections"),
      ).toBeInTheDocument();
    ...
    it("should display default help content", () => {
      ...
      const welcomeText = screen.getByText(
        /Welcome to Database DataGrid Manager/,
      );
  ...
  describe("Navigation", () => {
    it("should navigate between help topics", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Managing Database Connections/),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Search Functionality", () => {
    it("should search help content", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Search Results for 'SQL'"),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should clear search results", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Welcome to Database DataGrid Manager/),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Recently Viewed", () => {
    it("should show recently viewed topics", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          within(recentSection).getByText("Database Connections"),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("User Actions", () => {
    ...
    it("should toggle help preferences", async () => {
      ...
      const tooltipsCheckbox = screen.getByRole("checkbox", {
        name: /show tooltips/i,
      });
  ...
  describe("Error Handling", () => {
    ...
    it("should handle search errors gracefully", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Search temporarily unavailable"),
        ).toBeInTheDocument();
      });
    });
  });

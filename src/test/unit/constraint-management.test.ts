...
describe("ConstraintManagementService", () => {
  ...
  describe("ADD CONSTRAINT SQL Generation", () => {
    test("should generate ADD CONSTRAINT SQL for MySQL", () => {
      ...
      const sql = constraintService.generateAddConstraintSQL("users", constraint, mysqlConnection)

      expect(sql).toBe("ALTER TABLE `users` ADD CONSTRAINT `uk_users_email` UNIQUE (`email`)")
    })
    ...
    test("should generate ADD CONSTRAINT SQL for PostgreSQL", () => {
      ...
      const sql = constraintService.generateAddConstraintSQL("users", constraint, mockConnection)
    ...
    test("should throw error for SQLite ADD CONSTRAINT", () => {
      ...
      expect(() => {
        constraintService.generateAddConstraintSQL("users", constraint, sqliteConnection)
  ...
  describe("DROP CONSTRAINT SQL Generation", () => {
    ...
    test("should throw error for SQLite DROP CONSTRAINT", () => {
      ...
      expect(() => {
        constraintService.generateDropConstraintSQL("users", "uk_users_email", sqliteConnection)

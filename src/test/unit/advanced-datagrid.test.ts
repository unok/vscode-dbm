...
describe('AdvancedDataGridService', () => {
  ...
  beforeEach(() => {
    mockTableData = {
      ...
      rows: [
        { id: 1, email: 'john@example.com', name: 'John Doe', age: 30, created_at: '2023-01-01T10:00:00Z' },
        { id: 2, email: 'jane@example.com', name: 'Jane Smith', age: 25, created_at: '2023-01-02T11:00:00Z' },
        { id: 3, email: 'bob@example.com', name: 'Bob Johnson', age: 35, created_at: '2023-01-03T12:00:00Z' }
      ],
      totalRows: 3,
      offset: 0,
      limit: 50
  ...
  describe('Copy and Paste Functionality', () => {
    ...
    test('should copy entire rows', () => {
      ...
      expect(copyData.data[0]).toEqual([1, 'john@example.com', 'John Doe', 30, '2023-01-01T10:00:00Z'])
    })
  ...
  describe('Cursor AI Integration', () => {
    ...
    test('should learn from existing data patterns', async () => {
      ...
      const patterns = await aiIntegration.analyzeDataPatterns(mockTableData.rows, mockTableData.columns)
    ...
    test('should provide intelligent auto-completion', async () => {
      ...
      const completions = await aiIntegration.getAutoCompletions(
        'Jo',
        'name',
        mockTableData.rows
      )
...
function generateLargeDataset(size: number): TableData {
  return {
    ...
    columns: [
      { id: 'id', name: 'id', type: 'integer', nullable: false, isPrimaryKey: true, isAutoIncrement: true },
      { id: 'data', name: 'data', type: 'varchar(100)', nullable: true, isPrimaryKey: false, isAutoIncrement: false }
    ],

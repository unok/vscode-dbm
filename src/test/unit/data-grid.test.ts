...
describe("DataGridService", () => {
  ...
  describe("Sorting and Filtering", () => {
    it("should apply sorting to data", () => {
      ...
      // Act
      const sortedData = dataGridService.applySorting([{ id: "name", desc: false }])
    ...
    it("should apply column filters", () => {
      ...
      // Act
      const filteredData = dataGridService.applyFilters([{ id: "email", value: "john" }])
  ...
  describe("Performance Optimization", () => {
    ...
    it("should virtualize rows for memory efficiency", () => {
      // Arrange
      const virtualizedData = dataGridService.getVirtualizedRows(mockTableData.rows, {
        startIndex: 0,
        endIndex: 2,
      })
